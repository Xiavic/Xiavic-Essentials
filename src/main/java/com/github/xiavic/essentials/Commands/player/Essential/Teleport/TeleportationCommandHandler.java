...
public class TeleportationCommandHandler extends BaseCommand {
    ...
    @CommandAlias("back")
    @CommandPermission("Xiavic.player.back")
    ...
    @CommandPermission("Xiavic.player.rtp")
    ...
    @CommandAlias("spawn")
    @CommandPermission("Xiavic.player.spawn")
    ...
    @CommandAlias("spawn")
    @CommandPermission("Xiavic.staff.spawnothers")
    ...
    @CommandAlias("tpa")
    @CommandPermission("Xiavic.player.tpa")
